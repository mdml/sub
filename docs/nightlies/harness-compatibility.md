...
3. Run the behavioral contract suite against each installed real harness (the suite's opt-in real-harness mode), including launch, cross-process resume, and cancellation, on a throwaway working directory.
